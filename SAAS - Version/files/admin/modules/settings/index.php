      ...
      <div class="col-lg-9">
        <div class="tab-content">
          <div class="tab-pane fade show active" id="nav-api-key" role="tabpanel" aria-labelledby="nav-api-key-tab" tabindex="0">
            ...
            <fieldset class="border rounded-2 p-3 mb-4">
              <legend><h5><i class="bi bi-gear"></i> Cloud Translation API</h5></legend>
              <div class="row align-middle">
                ...
                <?php }else{ ?>
                  <div class="col-md-12">
                    <div class="form-floating mb-3 position-relative" data-toggle-password>
                      <input name="google_cloud_translation_api_key" type="password" class="form-control" id="floatingGoogleTranslateKey" placeholder="Cloud Translation API" value="<?php echo $get->google_cloud_translation_api_key; ?>">
                      <label for="floatingGoogleTranslateKey">Cloud Translation API</label>
                      <i class="bi bi-eye-slash toggle-password"></i>
                    </div>
                  </div>                
                <?php } ?>
