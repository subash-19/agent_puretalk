...
?>
  <script type="text/javascript">
    let YOUR_API_KEY = "<?php echo $config->google_cloud_translation_api_key; ?>";
  </script>
  ...
  <script src="<?php echo $base_url; ?>/admin/js/app.js?v=1"></script> 
  ...
  tinymce.init({
    ...
    toolbar: 'undo redo | blocks fontfamily fontsize | bold italic underline strikethrough | link image media table mergetags | align lineheight | tinycomments | checklist numlist bullist indent outdent | emoticons charmap | removeformat mybutton',
