            ...
            <?php 
                ...
                ?>
                    <tr class="align-middle">
                        ...
                        <td><?php if($showPurchases->payment_method == "stripe") echo "<i class='bi bi-stripe fs-5'></i> ".$lang['my_purchases_stripe'].""; else echo "<i class='bi bi-bank fs-5'></i> ".$lang['my_purchases_bank_deposit'].""; ?></td>
                        <td>
